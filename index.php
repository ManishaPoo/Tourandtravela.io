...
<div class="login-form-container">
    ...
    <form action="users.php" method="post" class="login-form">
        ...
        <button type="submit" value="login now" class="btn" name="send">login</button>
        <input type="checkbox" id="remember">
        <label for="remember">remember me</label>
        <p>forget password? <a href="#">click here</a></p>
        <p>don't have and account? <span class="switch-register-btn">register now</span></p>
    </form>
  
  <form action="register_form.php" method="post" class="register-form">
      
        <h3>Register</h3>
        <input type="Name" class="box" placeholder="enter your name" name="name">
        <input type="address" class="box" placeholder="enter your address" name="address">
        <input type="phone" class="box" placeholder="enter your phone" name="phone">
        <input type="email" class="box" placeholder="enter your email" name="email">
        <input type="password" class="box" placeholder="enter your password" name="password">
        <button type="submit" value="register now" class="btn" name="send">register</button>
        <input type="checkbox" id="remember">
        <label for="remember">remember me</label>
        <p>forget password? <a href="#">click here</a></p>
        <p>do have and account? <span class="switch-login-btn">login now</span></p>
    </form>
...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="travel_form.php" method="post" class="travel_form">
            ...
            <div class="inputBox">
                <h3>Email</h3>
                <input type="text" placeholder="place email" name="email">
            </div>
            <div class="inputBox">
                <h3>Phone</h3>
                <input type="number" placeholder="place number" name="phone">
            </div>
            <div class="inputBox">
                <h3>Address</h3>
                <input type="text" placeholder="place address" name="address" name="address">
            </div>
            <div class="inputBox">
                <h3>where to</h3>
...
<section class="footer">
    ...
    <h1 class="credit"> created by <span> Ms.</span> | all rights reserved! </h1>
